...
set :application, "bree"

role :app, "milevedent.adammiribyan.com"
role :web, "milevedent.adammiribyan.com"
role :db,  "milevedent.adammiribyan.com", :primary => true

set :scm, "git"
set :repository,  "git@github.com:adammiribyan/bree.git"
